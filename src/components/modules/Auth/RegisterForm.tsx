                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)}>
                            <div className="mb-8">
                                ...
                                <p className="text-[15px] mt-6 text-slate-600">Dont have an account <a href="javascript:void(0);" className="text-blue-600 font-medium hover:underline ml-1 whitespace-nowrap">Register here</a></p>
                            </div>
